...
// CODE HERE
// let one=one1
// function one1= (parameter1, parameter2) => console.log(`The first parameter is ${parameter1}. The second parameter is ${parameter2}`)
...
function greeetings(firstName, lastName, callback) {
    // let fullName = firstName + lastName;
    // return `Hello, my full name is ${fullName}`
    callback(firstName + lastName)
    }
    
    // console.log(greeting('ahh', ' man'));
    
 
// INVOKE 'GREETING FUNCTION' HERE
greeetings("ahh", "man", (fullName) =>
console.log('hello, my full name is ${tim}')
)
